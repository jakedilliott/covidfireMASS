# covidfireMASS/R/find_overhead.R
...
#'
#' Inspired by a fizzbuzz, this function finds which module types each agent has
#' been on and prints them out
#'
#' @param mod_data module assignment data
#'
#' @return character vector of agent role/module "types" (Overhead, OverheadCrew,
